...
class TaskConfig(PipelineConfig):
    ...
    domain: str = Field(default="bus_uclm_breast_lesion_seg")
    ...
    task_prompt: str = Field(
        default="This breast ultrasound image (BUS-UCLM). Segment breast lesions (benign and malignant) with a red mask.",
